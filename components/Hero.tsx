    ...
    >
      ...
      <div className="max-w-[95%] sm:max-w-[95%] md:max-w-6xl lg:max-w-7xl xl:max-w-8xl mx-auto px-4 sm:px-6 relative z-10 w-full pt-24 lg:pt-14 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[3.5rem] xl:text-[4rem] font-extrabold leading-[1.1] text-white tracking-tight mb-4">
              Junior Philippine
              <br />
              Computer Society
              <br />
              <span className="inline-block bg-neon text-navy px-4 sm:px-6 py-2 mt-4 sm:mt-5 rounded-full shadow-[0_0_40px_rgba(196,255,71,0.25)] transform -rotate-2 text-xl sm:text-2xl md:text-3xl lg:text-[2rem] xl:text-[2.5rem] tracking-normal">
                De La Salle Lipa
              </span>
            </h1>

            <p className="text-base md:text-lg text-white/60 max-w-md mt-4 leading-relaxed font-medium md:ml-6 lg:ml-2">
